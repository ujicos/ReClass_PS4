...
// Type: ReClassNET.Nodes.Matrix3x4Node
...
namespace ReClassNET.Nodes
{
  public class Matrix3x4Node : BaseMatrixNode
  {
    ...
    {
      name = "Matrix 3x4";
      icon = (Image) Resources.B16x16_Button_Matrix_3x4;
    }

    public override Size Draw(DrawContext context, int x2, int y2)
    {
      return this.DrawMatrixType(context, x2, y2, "Matrix (3x4)", 3, 4);
    }
